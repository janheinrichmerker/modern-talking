...
\begin{frame}{\Bert and Transformers}
  ...
  \begin{itemize}
    ...
    \item \Bert as classifier
    	\begin{itemize}
    		...
    		\item transformer encoder output as features to classification model
  ...
  \end{block}
    ...
    \begin{itemize}
    		...
    		%The BERT base architecture has L=12, H=768, A=12 and a 		%total of around 110M parameters. Here L refers to the number of %transformer blocks, H refers to the hidden size, A refers to the %number of self-attention head. For BERT large, L=24, H=1024, A=16.
